...
export default function WelcomeScreen() {
  ...
  return (
    <Screen>
      ...
      <SectionCard
        subtitle="Launch-ready MVP features"
        title="What you can do"
      >
        <View style={styles.featureList}>
          <Text style={styles.featureItem}>Personalized training split based on goal, schedule, equipment, and injuries.</Text>
          <Text style={styles.featureItem}>Deterministic calorie and macro targets with meal ideas and grocery support.</Text>
          <Text style={styles.featureItem}>Progress snapshots with adherence scoring and 3- and 6-month prediction ranges.</Text>
        </View>
      </SectionCard>
